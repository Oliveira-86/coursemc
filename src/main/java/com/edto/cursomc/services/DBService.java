...
public class DBService {
	...
	Client cl1 = new Client(null, "Maria Silva", "egberto.duarte.14@gmail.com", "00987856432" ,ClientType.PHYSICALPERSON);
	...
	Payment pay2 = new BoletoPayment(null, PaymentStatus.PENDING, o2, sdf.parse("21/09/2020 13:50"), sdf.parse("23/09/2020 15:00"));
	o2.setPayment(pay2);
